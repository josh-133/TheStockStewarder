...
**Tests**: Testing is REQUIRED. Every user story MUST include failing tests
before implementation work begins, and the generated tasks MUST preserve that
order.
...
- [ ] T003 [P] Configure linting, formatting, and automated test tooling
- [ ] T004 [P] Configure performance measurement and observability baselines
...
- [ ] T009 Configure error handling, logging, and upstream outage handling
- [ ] T010 Setup environment configuration and secret management
- [ ] T011 [P] Establish caching/freshness primitives and latency instrumentation
...
- [ ] T014 [P] [US1] Unit test for domain logic in tests/unit/test_[name].py
...
- [ ] T019 [US1] Add validation, stale-data labeling, and error handling
- [ ] T020 [US1] Add logging and latency metrics for user story 1 operations
...
- [ ] T023 [P] [US2] Unit test for domain logic in tests/unit/test_[name].py
...
- [ ] T030 [P] [US3] Unit test for domain logic in tests/unit/test_[name].py
...
- [ ] TXXX Accessibility review for charts, tables, and financial indicators
...
- Verify tests fail before implementing and before any feature code is added
- Include tasks for data freshness, degraded-mode handling, latency checks, and
  accessibility whenever the story touches those concerns
